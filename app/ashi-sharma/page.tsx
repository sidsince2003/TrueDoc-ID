      ...
      <div className="flex flex-col items-center justify-center flex-grow p-4 md:p-8">
        <div className="w-full max-w-4xl bg-white shadow-lg rounded-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 p-4 md:p-6 flex flex-col md:flex-row items-center">
            <Image
<<<<<<< HEAD:frontend/app/ashi-sharma/page.tsx
              src="/assets/Ashi.jpg"
=======
              src="/assets/ashi.jpg"
>>>>>>> 9ed4ac9f594dbbe0b3ba831519fda2d07fe54f84:app/ashi-sharma/page.tsx
              alt="Ashi Sharma"
              width={120}
              height={120}
              className="rounded-full border-4 border-white mb-4 md:mb-0 md:mr-6 h-4/6"
            />
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row items-center justify-between bg-gray-100 p-3 rounded-md">
                  ...
                  <button
                    className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm flex items-center w-full sm:w-auto justify-center"
                ...
                {documents.map((doc, index) => (
                  ...
                  >
                    ...
                    {doc.verified ? (
                      ...
                      <button className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm flex items-center w-full sm:w-auto justify-center">
                        <Download className="mr-1 h-4 w-4" /> Download
                      </button>
                    )}
                  </div>
