      ...
      <div className="flex flex-col items-center justify-center flex-grow p-8">
        <div className="w-full max-w-4xl bg-white shadow-lg rounded-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 p-6 flex items-center">
            ...
            />
            <div>
              <h1 className="text-3xl font-bold text-white">Zishan Khan</h1>
          ...
          <div className="p-6 grid grid-cols-2 gap-4 text-black">
            <div>
              ...
              <div className="space-y-2">
                <p>
                  <span className="font-medium text-black">Name:</span> Zishan
                  Khan
                </p>
                <p>
                ...
                <p>
                  <span className="font-medium text-black">Gender:</span> Male
                </p>
                <p>
                ...
                {documents.map((doc, index) => (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span
                        className={`${
                          doc.verified ? "text-green-700" : "text-black"
                        }`}
                      >
                        {doc.name}
                      </span>
